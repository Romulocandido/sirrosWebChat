...
<section id ="app">
    ...
    <main class="wrapper ai-window">
                ...
                <td>
                    ...
                    <div v-for="r in a.result.fulfillment.messages">
                        ...
                        <div class="mdc-card" v-if="r.type == '1'">
                            <img :title="r.title" :alt="r.title" class="mdc-card__media-item" :src="r.imageUrl" v-if="r.imageUrl">
                            ...
                            <section class="mdc-card__actions" v-for="button in r.buttons">
                                <a class="mdc-button mdc-button--compact mdc-button--primary mdc-card__action" target="_blank" :href="button.postback">{{button.text}} <i class="material-icons openlink">open_in_new</i></a>
                            </section>
                        </div>
        ...
        <br>
        <p class="copyright" :class="{'marged': bottom}" v-if="answers.length > 0" id="bottom">Proudly powered by <a href="http://sirros.io" target="_blank">Sirros IoT</a></p>
    </main>
</section>
</template>
    ...
    methods: {
        ...
        handle(response){
            if(response.result.fulfillment.speech || response.result.fulfillment.messages[0].type == 'simple_response'){
                ...
                speech.lang = 'pt-BR' // <- Nice british accent
